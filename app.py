...
command = st.text_input("O que deseja?", "Quais dispositivos legais na área do Direito do Consumidor juiz 3 referencia na maior parte das suas decisões?", disabled=False)
